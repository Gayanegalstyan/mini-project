...
def draw(canvas):
    ...
    # draw scores
    canvas.draw_text(str(score1),[100,50],50, "GREEN")
    canvas.draw_text(str(score2),[300,50],50, "BLUE")
...
frame.add_button("Restart",new_game, 130)
